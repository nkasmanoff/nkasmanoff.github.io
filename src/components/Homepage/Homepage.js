      ...
      <Row className="textbackground">
        <Col md={7}>
          ...
          <p className="aboutdetails">
            ...
            more! In my
            free time I enjoy running, watching TV, reading, messing with my Raspberry Pis, and trying to
        ...
        <Col md={5}>
        <Row>
        <iframe title="latest" height='454' width='300' frameborder='0' allowtransparency='true' scrolling='no' src='https://www.strava.com/athletes/84024114/latest-rides/50bb16f4ea78240738ca023b14a9caba581f81f0'></iframe>        
        </Row>
        </Col>
      </Row>
